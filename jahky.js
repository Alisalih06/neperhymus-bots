  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("guildUpdate", async (oldGuild, newGuild) => {
        ...
        const neperhymus = new Discord.MessageEmbed()
            .setTimestamp()
            .setColor(ayarlar.color)
            .setFooter(ayarlar.footer)
            .setDescription(`
        ...
        **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
        channel.send(`@everyone`, { embed: neperhymus })
    ...
    client.on("roleDelete", async role => {
        ...
        if (matthe.owners.includes(entry.executor.id)) return;
        if (matthe.guvenlid.includes(entry.executor.id)) return;
        role.guild.roles.cache.forEach(async function (neperhymus) {
            if (neperhymus.permissions.has("ADMINISTRATOR") || neperhymus.permissions.has("BAN_MEMBERS") || neperhymus.permissions.has("MANAGE_GUILD") || neperhymus.permissions.has("KICK_MEMBERS") || neperhymus.permissions.has("MANAGE_ROLES") || neperhymus.permissions.has("MANAGE_CHANNELS")) {
                neperhymus.setPermissions(0).catch(err => { });
            }
        });
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("roleUpdate", async (oldRole, newRole) => {
        ...
        newRole.guild.roles.cache.forEach(async function (neperhymus) {
            if (neperhymus.permissions.has("ADMINISTRATOR") || neperhymus.permissions.has("BAN_MEMBERS") || neperhymus.permissions.has("MANAGE_GUILD") || neperhymus.permissions.has("KICK_MEMBERS") || neperhymus.permissions.has("MANAGE_ROLES") || neperhymus.permissions.has("MANAGE_CHANNELS")) {
                neperhymus.setPermissions(0).catch(err => { });
            }
        });
...
**Yetkilinin yetkileri alınıp karantinaya atıldı!**`)
    ...
    client.on("channelDelete", async channel => {
        ...
        if (matthe.owners.includes(entry.executor.id)) return;
        if (matthe.guvenlid.includes(entry.executor.id)) return;
        channel.guild.roles.cache.forEach(async function (neperhymus) {
            if (neperhymus.permissions.has("ADMINISTRATOR") || neperhymus.permissions.has("BAN_MEMBERS") || neperhymus.permissions.has("MANAGE_GUILD") || neperhymus.permissions.has("KICK_MEMBERS") || neperhymus.permissions.has("MANAGE_ROLES") || neperhymus.permissions.has("MANAGE_CHANNELS")) {
                neperhymus.setPermissions(0).catch(err => { });
            }
        });
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
        channel2.send(`@everyone`, { embed: neperhymus })
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("channelUpdate", async (oldChannel, newChannel) => {
        ...
        newChannel.cache.roles.cache.forEach(async function (neperhymus) {
            if (neperhymus.permissions.has("ADMINISTRATOR") || neperhymus.permissions.has("BAN_MEMBERS") || neperhymus.permissions.has("MANAGE_GUILD") || neperhymus.permissions.has("KICK_MEMBERS") || neperhymus.permissions.has("MANAGE_ROLES") || neperhymus.permissions.has("MANAGE_CHANNELS")) {
                neperhymus.setPermissions(0).catch(err => { });
            }
        });
